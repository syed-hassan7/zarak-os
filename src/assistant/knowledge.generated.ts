...
export const ASSISTANT_KNOWLEDGE: AssistantKnowledgeEntry[] = [
  ...
  {
    "id": "customer-success",
    "title": "Customer-focused technical experience",
    "tags": [
      "customer-success",
      "account-management",
      "onboarding",
  ...
  },
  {
    ...
    "title": "Zarak's career background and experience",
    "tags": [
      "experience",
      "background",
      "career",
  ...
  },
  {
    ...
    "body": "Maternify is a multilingual, safety-gated AI maternal advocacy platform, built as a team project at the VibeHack London 2026 hackathon — a production-ready MVP shipped in 24 hours, placing 5th in the Health Impact track.\r\n\r\nIt hardcodes a safety gate that bypasses AI generation entirely for clinical red-flags, routing users straight to 999/triage cards instead of risking an \"AI reassurance\" response during a medical emergency. Built on Next.js 14 with GLM-5.1 and Gemini (multimodal speech-to-text/OCR, embeddings for RAG, text-to-speech for midwife-script playback), with an in-memory RAG system over curated NHS and Tommy's documentation so every advocacy script is clinically evidenced and cited.\r\n\r\nThe goal: give minority-ethnic women an advocacy \"voice\" during pregnancy, addressing documented maternal mortality disparities (MBRRACE-UK) with clinically-grounded scripts rather than plain translation."
  },
  {
    ...
    "aliases": [
      ...
      "what has he built",
      "what projects has zarak built",
      "what did zarak build",
      "what projects",
      "things built",
      "what has been built",
      "projects built",
  ...
  },
  {
    ...
    "body": "VenderScope is a continuous vendor risk intelligence platform built from the pain of managing 50+ vendor audits manually.\r\n\r\nIt monitors vendor risk signals across sources such as HIBP, NVD/NIST, Shodan, and Companies House, replacing annual point-in-time review with live weighted risk scoring and risk drift tracking.\r\n\r\nIt is designed to produce audit-ready PDF reports for ISO 27001 Annex A and Cyber Essentials-style reviews, written for both technical and non-technical stakeholders."
  },
  {
    "id": "zarak-os",
    "title": "ZARAK_OS",
    ...
    "body": "ZARAK_OS is an immersive portfolio OS web app built with React, TypeScript, Vite, and Three.js.\r\n\r\nIt uses a custom OS shell with window management, dock, menu bar, Spotlight, Mission Control, app windows, and a 3D workstation environment to present Zarak’s background, CV, LinkedIn snapshot, and projects as a product-like experience rather than a static website."
  },
  {
    "id": "security-grc",
    "title": "Security and GRC experience",
    "tags": [
      "security",
      "grc",
      "compliance",
  ...
  },
  {
    ...
    "aliases": [
      ...
      "will he need sponsorship",
      "student visa",
      "can he work in the uk",
      "eligible to work",
      "work eligibility",
      "relocation visa",
      "visa requirements",
      ...
      "unrestricted work",
      "can he work without sponsorship",
    ...
    "body": "Zarak is currently in the UK on a Student visa, tied to his MSc in Cyber Security at Nottingham Trent University (January 2025 to expected December 2026). The visa itself is valid until 25 May 2027.\n\nTimeline detail: from 25 January 2027 (the post-course wind-down period) until the visa expires on 25 May 2027, the Student visa permits unrestricted, full-time work in the UK with no study-term hour limits. That window is short and fixed — it ends on 25 May 2027 regardless of when a role starts.\n\nPractical bottom line for any hiring conversation: treat this as needing visa/work sponsorship up front for any offer, in the UK or elsewhere. Even during the unrestricted-work window, he wants sponsorship commitment settled at the offer stage rather than starting on a short bridge that expires in a few months — a role that cannot commit to sponsorship isn't viable long-term regardless of the exact start date.\n\nHe is genuinely open to relocating (Sweden, elsewhere in the EU, or otherwise), contingent on the hiring company being willing and able to sponsor a work visa. If a role cannot sponsor, say so plainly up front. If it can, he is motivated to relocate for it."
  },
  {
    "id": "why-hire-me",
    "title": "Why hire Zarak?",
    "tags": [
      "hire",
      "value",
      "strengths",
