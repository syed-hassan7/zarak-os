...
export default function VenderScope() {
  return (
    <div className="flex h-full flex-col overflow-hidden bg-os-bg/65">
      <div className="flex h-12 shrink-0 items-center gap-3 border-b border-white/10 bg-white/[0.045] px-4 backdrop-blur-xl">
        ...
        <div className="mx-auto flex min-h-full max-w-4xl flex-col justify-center gap-5">
          <section className="overflow-hidden rounded-3xl border border-white/10 bg-os-surface/45 shadow-2xl shadow-black/20">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group block p-6 outline-none focus-visible:ring-2 focus-visible:ring-os-accent/70 focus-visible:ring-inset"
            >
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.025))] p-7 transition-colors group-hover:border-white/18">
                ...
                <div className="relative grid gap-5 md:grid-cols-[1.15fr_0.85fr]">
                  <div className="space-y-4">
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                      <div className="h-20 rounded-2xl border border-os-accent/12 bg-os-accent/[0.055]" />
                      <div className="h-20 rounded-2xl border border-white/8 bg-white/[0.045]" />
                      <div className="h-20 rounded-2xl border border-white/8 bg-white/[0.035]" />
                    </div>
                  </div>
